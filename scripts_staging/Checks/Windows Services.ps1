...
.CHANGELOG
    ...
    08.01.26 SAN Added AppX Deployment Service (AppXSVC) to ignored due to an update
#>
...
$ignoredByDefault = @(
    ...
    "AppXSVC" # https://learn.microsoft.com/en-us/answers/questions/5660157/appxsvc-forced-to-automatic-on-server-2025
